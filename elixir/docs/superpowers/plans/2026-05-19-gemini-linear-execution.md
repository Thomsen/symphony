...
- [ ] **Step 1: Create failing test for MCP tool discovery**
...
- [ ] **Step 2: Implement `McpAdapter` module structure**
Implement `handle_request/1` and the protocol bridging logic.

- [ ] **Step 3: Implement Stdio main loop**
...
- [ ] **Step 1: Add `mcp-adapter` command to `evaluate/2`**
Register the command to start the adapter loop.

- [ ] **Step 2: Update `usage_message`**
...
- [ ] **Step 1: Update `session/new` ACP call**
